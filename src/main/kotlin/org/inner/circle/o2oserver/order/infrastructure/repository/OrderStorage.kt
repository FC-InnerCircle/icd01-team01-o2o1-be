...
class OrderStorage(
    ...
    override fun findOrderDetailByOrderId(
        orderId: Long
    ): Order {
    ...
    override fun findOrderListByMemberId(
        memberId: Long
    ): List<Order> {
    ...
    override fun subscribeDelivery(
        orderId: Long,
        memberId: Long
    ): Flow<Delivery> = flow {
